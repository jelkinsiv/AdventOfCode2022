...
map = Map((MAP_HEIGHT + 2) * 2, MAP_HEIGHT + 2, min_x - 104, min_y)
map.loadObstacles(line_paths)
map.addLine((0 + map.x_offset, map.height - 1),(map.width + map.x_offset - 1, map.height - 1))
sand_emitter = (500, 0)
...
while run_simulation:
    ...
    if map.tiles[sand_emitter[1] - map.y_offset][sand_emitter[0] - map.x_offset].isCollidable:
